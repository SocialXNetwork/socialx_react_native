...
export default {
	...
	'nodes.screen.description': 'Here you can change the node that you are currently using.',
	'nodes.screen.node.text': 'Node',
	'nodes.screen.picker.title': 'Select node',
	'nodes.progress.message': 'Updating node',

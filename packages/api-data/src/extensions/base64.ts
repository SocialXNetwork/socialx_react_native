...
export const Base64 = {
	...
	atob: (str: string) => {
		...
		let i = 0;
		do {
			const b1 = Base64.characters.indexOf(str.charAt(i++));
			const b2 = Base64.characters.indexOf(str.charAt(i++));
			const b3 = Base64.characters.indexOf(str.charAt(i++));
			const b4 = Base64.characters.indexOf(str.charAt(i++));

...
const {staticRequireMap} = require('./index');
  ...
  normalize (op, alg) {
    ...
    if (typeof alg === 'object') {
      ...
      try {
        ...
        //desiredType = reactNative ? staticRequireMap[op][algName] : require(registeredAlgorithms[algName]);
        desiredType = staticRequireMap[op][algName]
